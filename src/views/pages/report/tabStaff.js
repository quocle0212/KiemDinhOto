...
const TabStaff = ({ active, intl }) => {
  ...
  const getTotalPatern = (paramPatern) => {
    tabStaffService.countStationUser(paramPatern).then((result) => {
      if (result) {
  ...
  const getTotalTechnician = (paramTechnician) => {
    tabStaffService.countStationUser(paramTechnician).then((result) => {
      if (result) {
  ...
  const getTotalHigh = (paramHigh) => {
    tabStaffService.countStationUser(paramHigh).then((result) => {
      if (result) {
  ...
  const getTotalAccountant = (paramAccount) => {
    tabStaffService.countStationUser(paramAccount).then((result) => {
      if (result) {
